    ...
    <StyledUser>
     <div className="container">
      ...
      <div className="userLogo">
       <img src="https://www.gravatar.com/avatar/b898efbb2cb1b3498a9c9177fb098121?s=256&amp;d=identicon&amp;r=PG&amp;f=y&amp;so-version=2" 
        alt="SEB_FE_43_유호균's user avatar" width="128" height="128" className="userLogo" />
      </div>
      <div className="userTop">
      <div className="userProfile">
           <div className="userName">
            <div className="userNaming">
           SEB_FE_43_유호균
           </div>
           </div>
      </div>
           <div className="userInfo">
            ...
            <div className="items">
              <div className="item2">
                ...
                <div  className="item2lastSeen">
                   Member for 
                   <div className="lastSeen">Last seen this week</div>
                </div>
              </div>
            </div>
            <div className="items">
              <div className="item3">
                ...
                <svg aria-hidden="true" className="svg-icon iconCalendar" width="18" height="18" viewBox="0 0 18 18">
                ...
                <div  className="item3dailyVisit">
                   Member for 
                   <div className="visited">Visited 6 days, 3 consecutive</div>
                </div>
              </div>
            </div>
           </div>
      ...
      <div className="editButton">
        <span className="editBt">Edit profile</span>
      </div>
