  ...
  function SOInfo() {
    return (
      <StyledSoinfoSection>
         <div className="main">
        <div className="main">
        <div className="header">Join the Stack Overflow community</div>
  
        <div className="mainIcon">
          <div>
            <svg width="26" height="26" className="svgIcon" fill="var(--btn-bg-color)">
              ...
              </svg>Get unstuck — ask a question</div>
        </div>
        <div className="mainIcon">
          <div>
            <svg width="26" height="26" className="svgIcon" fill="var(--btn-bg-color)">
              ...
              </svg>Unlock new privileges like voting and commenting</div>
        </div>
        <div className="mainIcon">
          <div>
            <svg width="26" height="26" className="svgIcon" fill="var(--btn-bg-color)">
              ...
              </svg>Save your favorite tags, filters, and jobs</div>
        </div>
        <div className="mainIcon">
          <div>
            <svg width="26" height="26" className="svgIcon" fill="var(--btn-bg-color)">
              ...
              </svg>Earn reputation and badges</div>
        </div>
