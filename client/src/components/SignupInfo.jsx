      ...
      <div className="px-5 pt-3 pb-10 bg-white rounded-md drop-shadow-xl">
        <form className="form" onSubmit={onSubmit}>
          ...
          <div className="flex-col justify-center mx-2 my-3">
            ...
            <input type="password" value={password}  onChange={handlePassword} className={borderColor[!!passwordError]}/>
            {passwordError && (
              <p className="text-xxs text-danger-500">
          ...
          <label htmlFor="file-input">Choose a file: <input type="file" id="file-input" />
